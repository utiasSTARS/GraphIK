...
if __name__ == '__main__':
    ...
    robot_file = "results/ur10_bounded_" + "False" + "_tol_" + str(tol) + "_maxiter_2000_n_goals_" + str(n_goals) + \
                "_n_init_1_zero_init_True_full_results.p"

    data = pickle.load(open(robot_file, "rb"))

    robot_limits_file = "results/ur10_bounded_" + "True" + "_tol_" + str(tol) + "_maxiter_2000_n_goals_" + str(n_goals) + \
                "_n_init_1_zero_init_True_full_results.p"
