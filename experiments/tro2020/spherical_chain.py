...
if __name__ == "__main__":
    ...
    if fabrik_only:
        save_string = "results/FABRIK_only_spherical_chain_" + make_save_string(save_string_properties)
    else:
        save_string = "results/spherical_chain_" + make_save_string(save_string_properties)


    print("Creating robot objects")
    # Robot params
